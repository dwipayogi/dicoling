...
const translations = {
  ID: {
    ...
    profil: {
      ...
      editButton: "Edit",
      cancelButton: "Batal",
      successUpdateMessage: "Profil berhasil diperbarui.",
      errorUpdateMessage: "Gagal memperbarui profil.",
      passwordLabel: "Password Baru (Opsional)",
  ...
  FR: {
    ...
    profil: {
      ...
      successUpdateMessage: "Profil mis à jour avec succès.",
      errorUpdateMessage: "Échec de la mise à jour du profil.",
      passwordLabel: "Nouveau mot de passe (Optionnel)",
      passwordPlaceholder: "Laissez vide si inchangé",
    },
  },
} as const;
